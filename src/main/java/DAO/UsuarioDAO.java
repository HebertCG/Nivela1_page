...
public class UsuarioDAO {
        ...
        try {
            try (Connection conn = conecct.getConnection()) {
                String sql = "SELECT u.*, r.nombre as rol_nombre FROM usuarios u " +
                        ...
                        "WHERE u.correo = ? AND u.password = ? AND u.estado = 1";
    ...
    public void insertar(Usuario usuario) throws SQLException {
        ...
        try (Connection con = conecct.getConnection();
            ...
            // carrera es opcional para administradores y docentes
            ...
            throw e; // Re-lanzar para que el servlet muestre el error real
        }
    }
