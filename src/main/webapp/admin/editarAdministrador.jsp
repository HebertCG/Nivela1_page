                    ...
                    <div class="d-flex">
                        <div class="sidebar">
                            ...
                            <ul class="nav flex-column w-100 px-2">
                                ...
                                <li class="nav-item mb-2">
                                    <a href="" class="nav-link sidebar-active" <i class="fas fa-user-shield"></i>
                                        Administradores
                                    </a>
                                </li>
                                ...
                                <li class="nav-item mb-2">
                                    <a href="" class="nav-link"><i class="fas fa-user-graduate"></i>
                                        Preinscripciones</a>
                                </li>
                        ...
                        <div class="main-content">
                            <div class="card p-4">
                                <h3 class="card-title text-center mb-4"><i class="fas fa-edit"></i> Editar Administrador
                                </h3>
                                <form action="${pageContext.request.contextPath}/ActualizarAdministradorServlet"
                                    method="post" class="row g-3">
                                    <input type="hidden" name="id" value="${admin.id}" />

                                    <div class="col-md-6">
                                        <label>Nombre:</label>
                                        <input type="text" name="nombre" class="form-control" value="${admin.nombre}"
                                            required />
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="correo" class="form-control" value="${admin.correo}"
                                            required />
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-success btn-form">Actualizar admin</button>
                                        <a href="${pageContext.request.contextPath}/ListarAdministradoresServlet"
                                            class="btn btn-secondary btn-form">Cancelar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
