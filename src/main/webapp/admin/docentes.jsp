...
<head>
    ...
    <style>
        ...
        .card-icon { width: 48px; height: 48px; background: linear-gradient(135deg, #14B8A6, #0D9488); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: white; font-size: 1.5rem; }
        ...
        .btn-primary-custom { background: linear-gradient(135deg, #14B8A6, #0D9488); border: none; color: white; padding: 0.75rem 2rem; border-radius: 10px; font-weight: 600; transition: all 0.3s ease; }
        .btn-primary-custom:hover { transform: translateY(-2px); box-shadow: 0 8px 16px rgba(20,184,166,0.3); }
        ...
        <div class="content-wrapper">
            ...
            <main class="dashboard-main">
                <div class="page-header">
                    ...
                    <p class="page-subtitle">Registra y administra los docentes del sistema</p>
                </div>
                ...
                <div class="content-card">
                    ...
                    <form action="${pageContext.request.contextPath}/RegistrarDocente" method="post">
                        <div class="row g-3">
                            <div class="col-md-6">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="empty-state">
                                ...
                                <p>Los docentes que registres apareceran aqui</p>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
