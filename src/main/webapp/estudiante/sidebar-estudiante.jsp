<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <% String sidebarActive=(String) request.getAttribute("sidebarActive"); if (sidebarActive==null) sidebarActive="" ;
        ...
        <style>
            /* ==========================================
   SIDEBAR ESTUDIANTE - ESTILOS AUTOCONTENIDOS
   ========================================== */

            :root {
                --estudiante-primary: #1A1A2E;
                --estudiante-secondary: #16213E;
                --estudiante-accent: #00D9C0;
                --estudiante-hover: rgba(0, 217, 192, 0.1);
                --sidebar-width: 280px;
            ...
            .estudiante-sidebar {
                ...
                height: 100vh;
                background: linear-gradient(180deg, var(--estudiante-primary) 0%, var(--estudiante-secondary) 100%);
                color: white;
                display: flex;
            ...
            .estudiante-sidebar[data-collapsed="true"] {
            ...
            .estudiante-sidebar[data-collapsed="true"] .sidebar-logo-container {
                opacity: 0;
                pointer-events: none;
            }
            ...
            .nav-link:hover {
                background: var(--estudiante-hover);
                color: white;
            }
            ...
            .estudiante-sidebar[data-collapsed="true"] .nav-indicator {
                display: none;
            }
            ...
            .estudiante-sidebar[data-collapsed="true"] .nav-text {
                opacity: 0;
                pointer-events: none;
                position: absolute;
            }

            .estudiante-sidebar[data-collapsed="true"] .nav-link {
                justify-content: center;
                padding: 1rem 0.5rem;
                margin: 0.25rem 0.5rem;
            }

            .estudiante-sidebar[data-collapsed="true"] .nav-link i {
                margin: 0;
            }
            ...
            .estudiante-sidebar[data-collapsed="true"] .logout-link {
                justify-content: center;
                padding: 1rem 0.5rem;
                margin: 0 0.5rem;
            }

            .estudiante-sidebar[data-collapsed="true"] .logout-link i {
                margin: 0;
            }

            .estudiante-sidebar[data-collapsed="true"] .logout-link .nav-text {
                display: none;
            }
            ...
            @media (max-width: 991.98px) {
                ...
                .estudiante-sidebar.is-open[data-collapsed="true"] {
                    width: var(--sidebar-width);
                }
            ...
            .estudiante-sidebar[data-collapsed="true"]~.main-content-wrapper {
        ...
        <aside class="estudiante-sidebar" id="estudianteSidebar" data-collapsed="false" aria-label="Menú lateral">
            <div class="sidebar-header">
                <button class="sidebar-toggle" id="estudianteSidebarToggle" type="button" aria-label="Abrir/cerrar menú"
                    aria-expanded="true">
            ...
            <div class="sidebar-footer">
                <a class="logout-link" href="${pageContext.request.contextPath}/salir" data-bs-toggle="tooltip"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var sidebar = document.getElementById('estudianteSidebar');
                if (!sidebar) return;

                var internalToggle = document.getElementById('estudianteSidebarToggle');
