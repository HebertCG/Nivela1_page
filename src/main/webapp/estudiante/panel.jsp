                    ...
                    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                      <%@ include file="verificarEstudiante.jsp" %>
                        <% if ("true".equals(request.getParameter("logout"))) { session.invalidate();
                          ...
                          request.setAttribute("sidebarActive", "dashboard" ); List<SeccionInfo> clasesAsignadas = new
                          ArrayList<>();
                            if (usuario != null) {
                            ...
                            String diaActualSistema = LocalDate.now().getDayOfWeek().getDisplayName(TextStyle.FULL,
                            localeEs);
                                                ...
                                                <div class="section-card">
                                                  <div
                                                    ...
                                                    <div>
                                                      ...
                                                      <p class="class-meta mb-0 text-capitalize">${empty diaActual ? ""
                                                        : diaActual}</p>
                                                    </div>
                                                            ...
                                                            <div
                                                              ...
                                                              <div>
                                                                ...
                                                                <p class="class-meta mb-0">
                                                                  ...
                                                                  &middot;
                                                                  ${empty clase.profesor ? "Profesor por asignar" :
                                                                  clase.profesor}
                                                                </p>
                                                              </div>
                                                              <span class="badge-section">
                                                                ${empty clase.carrera ? (empty clase.grupo ? "Seccion" :
                                                                clase.grupo) : clase.carrera}
                                                              </span>
                                                            </div>
                                                            <div class="schedule mt-3">
                                                              <span><i class="bi bi-clock me-1"></i>${clase.horaInicio}
                                                                - ${clase.horaFin}</span>
                                                              <span><i class="bi bi-people me-1"></i>${empty clase.grupo
                                                                ? "Grupo por asignar" : clase.grupo}</span>
                                                            </div>
                                                          </div>
                                                        </div>
                                                      </c:forEach>
                                                    ...
                                                    <c:otherwise>
                                                      <div class="class-card text-center">
                                                        <div class="class-card-content">
                                                          ...
                                                          <p class="class-meta mb-3">Revisa tu horario para conocer
                                                            todas tus secciones.</p>
                                                  ...
                                                  <div class="attendance-list">
                                                    <div class="attendance-item"><span>Lunes, 3 de noviembre</span><span
                                                        class="attendance-status status-success"><i
                                                          class="bi bi-check-circle"></i> Asistió</span></div>
                                                    <div class="attendance-item"><span>Domingo, 2 de
                                                        noviembre</span><span
                                                        class="attendance-status status-success"><i
                                                          class="bi bi-check-circle"></i> Asistió</span></div>
                                                    <div class="attendance-item"><span>Sábado, 1 de
                                                        noviembre</span><span
                                                    ...
                                                    <div class="attendance-item"><span>Miércoles, 29 de
                                                        octubre</span><span class="attendance-status status-success"><i
                                                          class="bi bi-check-circle"></i> Asistió</span></div>
                                                ...
                                                <div class="section-card">
                                                  ...
                                                  <div class="announcement-card shadow-sm">
                                                    ...
                                                    <div class="card-body">
                                                      ...
                                                      <p>Obtén certificados reconocidos internacionalmente y destaca.
                                                      </p>
                                                      <a href="#">Más información <i
