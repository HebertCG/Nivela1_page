    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            ...
            <head>
                <meta charset="UTF-8" />
                <title>
                    <fmt:message key="titulo.intranet" />
                </title>
                ...
                <div class="main-container">
                    ...
                    <div class="right-section">
                        ...
                        <c:if test="${param.error == 'sesion'}">
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle"></i> Tu sesión ha expirado. Por favor inicia
                                sesión nuevamente.
                            </div>
                        </c:if>
                        <c:if test="${param.error == 'permisos'}">
                            <div class="alert alert-danger">
                                <i class="fas fa-lock"></i> No tienes permisos para acceder a esa sección.
                            </div>
                        </c:if>
