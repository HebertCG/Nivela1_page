...
<%
    ...
    String inicialDocente = (docente != null && docente.getNombre() != null && !docente.getNombre().isEmpty()) 
        ? docente.getNombre().substring(0, 1).toUpperCase() 
        : "D";
...
<style>
/* ==========================================
   TOPBAR DOCENTE - ESTILOS COMPLETOS
   ========================================== */
...
<header class="dashboard-topbar">
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="topbar-info">
            ...
            <h6 class="topbar-greeting">Bienvenido de vuelta, <span class="text-uppercase"><%= nombreDocente %></span></h6>
        </div>
    </div>
    ...
    <div class="topbar-actions">
        ...
        <div class="user-pill">
            ...
            <div>
                <p class="mb-0 fw-semibold text-uppercase"><%= nombreDocente %></p>
